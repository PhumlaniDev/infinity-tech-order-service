...
import com.phumlanidev.orderservice.event.dlq.PaymentRequestedEventDlqPublisher;
...
@Component("paymentEventRequestedKafkaListenerErrorHandler")
@RequiredArgsConstructor
@Slf4j
public class PaymentEventRequestedKafkaListenerErrorHandler implements KafkaListenerErrorHandler {
